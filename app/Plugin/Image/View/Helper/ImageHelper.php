...
class ImageHelper extends AppHelper{
    ...
    public function resizedUrl($file, $width, $height){
        ...
        if(!is_dir($pathinfo['dirname'] . '/resized')){
            mkdir($pathinfo['dirname'] . '/resized', 0777);
        }
        $output     = $pathinfo['dirname'] . '/resized/' . $pathinfo['filename'] . '.' . $pathinfo['extension'];
