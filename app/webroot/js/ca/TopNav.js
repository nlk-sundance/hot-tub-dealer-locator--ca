...
function printTopNav() {
	...
	if (section == "RequestLit" ) {
		document.write('<b><A HREF="http://ca.sundancespas.com/RequestLiterature/RequestLiterature.html" CLASS="nav">DEMANDEZ UNE BROCHURE</A>&nbsp;&nbsp;&nbsp;&nbsp;</b>');
	}
	else {
	...
	if (section == "CustomerCare" ) {
		document.write('<b><A HREF="http://ca.sundancespas.com/CustomerCare/CustomerCare.html" CLASS="nav">ASSISTANCE &Aacute; LA CLIENT&Eacute;LE</A>&nbsp&nbsp;&nbsp;</b>');
	}
	else {
		document.write('<A HREF="http://ca.sundancespas.com/CustomerCare/CustomerCare.html" CLASS="nav">ASSISTANCE &Aacute; LA CLIENT&Eacute;LE</A>&nbsp&nbsp;&nbsp;&nbsp;');
	}
	if (section == "Contact" ) {
